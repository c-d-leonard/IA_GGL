# This file contains functions which are shared between the method from Blazek et al 2012 and the shape measurement method.
...
def window():
	""" Get window functions w_{l+} and w_{ls} 2-halo terms. Tag = '+g' or 'gg', determines dndz's."""
...
def wgg_2halo(rp_cents_, bd, bs):
	...
	np.savetxt('./txtfiles/wgg_2halo_'+str(pa.kpts_wgg)+'pts_LRG.txt', wgg_stack)
...
def wgg_full(rp_c):
	...
	plt.savefig('./plots/wgg_tot_LRG.pdf')
	plt.close()
