...
def get_bSigW(z_p_min, z_p_max, e_rms, sigz):
	...
	for zi in range(0,len(z_p_vec)):
		...
		zsvec = np.random.normal(z_p_vec[zi], sigz, 5000000)
...
def get_gammaIA_cov(rp_bins, rp_bins_c, alpha_sys, zs_sys, sigz_sys):
	...
	plt.ylabel('$F$')
	plt.xlim(0.04, 20)
	plt.savefig('./plots/F_%sys='+str((pa.alpha_fid- alpha_sys) / pa.alpha_fid)+'_TESTAPR25.pdf')
	plt.close()
	...
	plt.ylabel('$\Sigma_c$')
	plt.xlim(0.04, 20)
	plt.savefig('./plots/SigC_%sys='+str((pa.alpha_fid- alpha_sys) / pa.alpha_fid)+'_TESTAPR25.pdf')
	plt.close()
	...
	plt.ylabel('$\Sigma_c$')
	plt.xlim(0.04, 20)
	plt.savefig('./plots/cz_%sys='+str((pa.alpha_fid- alpha_sys) / pa.alpha_fid)+'_TESTAPR25.pdf')
	plt.close()
	...
	plt.ylabel('$\Sigma_c$')
	plt.xlim(0.04, 20)
	plt.savefig('./plots/DeltaEst_%sys='+str((pa.alpha_fid- alpha_sys) / pa.alpha_fid)+'_TESTAPR25.pdf')
	plt.close()
	...
	np.savetxt('./txtfiles/frac_StatError_Blazek_LRG-shapes_TESTAPR25.txt', save_variance)
	...
	plt.ylabel('$\Sigma_c$')
	plt.xlim(0.04, 20)
	plt.savefig('./plots/gamma_sp_%sys='+str((pa.alpha_fid- alpha_sys) / pa.alpha_fid)+'_TESTAPR25.pdf')
	plt.close()
	...
	plt.xlabel('$r_p$')
	plt.xlim(0.04, 20)
	plt.savefig('./plots/sigma_sp_%sys='+str((pa.alpha_fid- alpha_sys) / pa.alpha_fid)+'_TESTAPR25.pdf')
	plt.close()
	...
	plt.xlabel('$r_p$')
	plt.xlim(0.04, 20)
	plt.savefig('./plots/gIA_%sys='+str((pa.alpha_fid- alpha_sys) / pa.alpha_fid)+'_TESTAPR25.pdf')
	plt.close()
	...
	plt.ylabel('$\sigma(\gamma_{IA})$')
	plt.xlim(0.04, 20)
	plt.savefig('./plots/frac_sys_errors_Blazek_LRG-shapes_%sys='+str((pa.alpha_fid- alpha_sys) / pa.alpha_fid)+'_TESTAPR25.pdf')
	plt.close()
	...
	plt.ylabel('$\sigma(\gamma_{IA})$')
	plt.xlim(0.04, 20)
	plt.savefig('./plots/sys_errors_Blazek_LRG-shapes_'+str((pa.alpha_fid- alpha_sys) / pa.alpha_fid)+'_TESTAPR25.pdf')
	plt.close()

	# Save the fractional sys error
	save_variance = np.column_stack((rp_bins_c, np.sqrt(np.diag(gamma_IA_sys_cov)) / g_IA_fid))
	np.savetxt('./txtfiles/frac_SysError_Blazek_LRG-shapes_'+str((pa.alpha_fid- alpha_sys) / pa.alpha_fid)+'_TESTAPR25.txt', save_variance)
	...
	np.savetxt('./txtfiles/frac_totalError_Blazek_LRG-shapes_'+str((pa.alpha_fid- alpha_sys) / pa.alpha_fid)+'_TESTAPR25.txt', save_variance)
	...
	plt.ylabel('$\sigma(\gamma_{IA})$')
	plt.xlim(0.04, 20)
	plt.savefig('./plots/absolute_error_Blazek_LRG-shapes_'+str((pa.alpha_fid- alpha_sys) / pa.alpha_fid)+'_TESTAPR25.pdf')
	plt.close()
...
def plot_variance(cov_1, fidvalues_1, bin_centers):
	...
	plt.tight_layout()
	plt.savefig('./plots/stat+sys_log_BlazekMethod_LRG-shapes_'+str((pa.alpha_fid- pa.alpha_sys[i]) / pa.alpha_fid)+'_TESTAPR25.pdf')
	plt.close()
	...
	fig_sub.tick_params(axis='both', which='minor', labelsize=12)
	plt.tight_layout()
	plt.savefig('./plots/stat+sys_notloBlazekMethod_LRG-shapes_7bins_'+str((pa.alpha_fid- pa.alpha_sys[i]) / pa.alpha_fid)+'_TESTAPR25.pdf')
	plt.close()
