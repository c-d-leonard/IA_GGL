# This is a script which constrains the (amplitude? parameters of a model?) of intrinsic alignments, using the method of Blazek et al 2012.

import numpy as np
import IA_params as pa
import scipy
...
Cov_gIA		= 	get_gammaIA_cov(Cov_a, Cov_b, np.zeros(len(np.diag(Cov_b))))
