...
\end{equation}
where $z_{\rm p}^{\rm close,max}$ and $z_{\rm p}^{\rm close,min}$ are respectively the maximum and minimum photo-z which are included when selecting sources close enough to the lense to contribute to IA. {\it There is a similar correction factor due to scattering from bad photo-z's required here; to do.}
